...
import { FactCategory, FactStatus, TemporalType } from "../../common/types.js";
...
const STATUSES: FactStatus[] = ["active", "superseded", "expired"];
const TEMPORAL_TYPES: TemporalType[] = ["permanent", "ongoing", "temporary", "event"];
...
const factSchemaDefinition = {
  ...
  temporalType: { type: String, enum: TEMPORAL_TYPES, required: true, default: "ongoing" },
